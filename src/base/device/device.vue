      ...
      <div class="form-container">
        <div class="searchForm-container">
          <el-form inline ref="searchForm" :model="searchForm" size="small">
            ...
            <el-form-item label="是否被借用">
              <el-select v-model="searchForm.status" placeholder="设备状态" class="input">
                <el-option label="被借" value='borrow'></el-option>
                <el-option label="在库" value='wait'></el-option>
                <el-option label="损坏" value='bad'></el-option>
              </el-select>
            </el-form-item>
            <el-form-item>
        ...
        <!--<div class="add-button-container">
          <el-button class="button" size="small" type="myPrimary" @click="addClick()">添加设备</el-button>
        </div>-->
        <div class="table-container">
          <el-table :data="tableData" style="width: 100%" size="small" :header-cell-style="{backgroundColor:'#ECF6FF'}">
            <!-- <el-table-column fixed align="center" prop="id" label="设备号" min-width="40px"></el-table-column>-->
            ...
            <el-table-column align="center" prop="courseName" label="所属课程名称" min-width="35px"></el-table-column>
            <el-table-column fixed align="center" prop="status" label="设备状态" min-width="40px">
              <template slot-scope="scope">
                <span v-if="scope.row.status === 'borrow'">被借</span>
                <span v-if="scope.row.status === 'wait'">在库</span>
                 <span v-if="scope.row.status === 'bad'">损坏</span>
              </template>
            </el-table-column>
            ...
            <!--<el-table-column align="center" label="操作" fixed="right" min-width="60px">
              <template slot-scope="scope">
                ...
                <el-button type="text" size="mini" class="color-green" @click="sendBorrow(scope.row)" v-if="role==='ADMIN'">查看借用记录</el-button>
